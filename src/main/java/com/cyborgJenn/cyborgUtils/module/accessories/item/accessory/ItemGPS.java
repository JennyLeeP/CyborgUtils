...
public class ItemGPS extends Item implements IAccessory
{
	public ItemGPS()
	{
		super();
		this.setUnlocalizedName("gps");
	...
	{
		tooltip.add("One of them there fancy satelite thingies. Displays compass, time, location and moon phases on the HUD.");
	}
}
