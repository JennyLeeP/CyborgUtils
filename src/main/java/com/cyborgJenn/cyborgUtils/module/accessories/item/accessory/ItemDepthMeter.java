...
public class ItemDepthMeter extends Item implements IAccessory
{
	public ItemDepthMeter()
	{
		super();
		this.setUnlocalizedName("depthMeter");
	...
	{
		tooltip.add("Displays Player's vertical position on the HUD");
	}
}
